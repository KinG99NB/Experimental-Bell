        ...
        return Exp.sendMessage(number || id, {
            text:`${_text ? (_text + "\n\n" + text) : text}`,
                contextInfo: {
                    ...
                    mediaUrl: `http://ẉa.me/6282311832871/${!cust ? "89e838":"jeie337"}`,
        ...
        const menu = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: url,
                    sourceUrl: "https://github.com/KinG99NB",
                    mediaUrl: "http://ẉa.me/6282311832871/"+Math.floor(Math.random() * 100000000000000000),
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                },
        ...
        const mess = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    sourceUrl: "https://github.com/KinG99NB",
                    mediaUrl: `http://ẉa.me/6282311832871/${user.charging ? "2733":"2734"}`,
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                }
